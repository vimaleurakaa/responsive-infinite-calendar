...
import { EventCardType } from "../../../components/Store/helper";
...
var Day = (function (_PureComponent) {
  ...
  Day.prototype.renderSelection = function renderSelection(selectionColor) {
    ...
    return React.createElement(
      ...
      React.createElement("span", { className: styles.day }, day)
    );
  };

  Day.prototype.render = function render(args) {
    var _classNames;
    ...
    return React.createElement(
      ...
      _extends(
        {
          ...
          className: classNames(
            styles.root,
            ((_classNames = {}),
            (_classNames[styles.today] = isToday),
            (_classNames[styles.highlighted] = isHighlighted),
            (_classNames[styles.selected] = isSelected),
            (_classNames[styles.disabled] = isDisabled),
            (_classNames[styles.enabled] = !isDisabled),
            _classNames),
            className
          ),
      ...
      <EventCard date={date} type={EventCardType} />,
      day === 1 &&
        React.createElement("span", { className: styles.month }, monthShort),
      isToday ? (
        React.createElement("span", null, day)
      ) : (
        <span className="Cal__date_grid">{day}</span>
      ),
      day === 1 &&
        currentYear !== year &&
        React.createElement("span", { className: styles.year }, year),
