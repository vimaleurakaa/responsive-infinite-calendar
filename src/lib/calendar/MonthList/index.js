...
var MonthList = (function (_Component) {
    ...
    return (
      (_ret =
        ...
        (_this.scrollToDate = function (date) {
          ...
          (_this2 = _this).scrollTo.apply(
            _this2,
            [offsetTop + offset].concat(rest)
          );
        }),
  ...
  MonthList.prototype.componentWillReceiveProps =
  ...
  MonthList.prototype.render = function render() {
    ...
    return React.createElement(VirtualList, {
      ...
      className: classNames(
        styles.root,
        ((_classNames = {}),
        (_classNames[styles.scrolling] = isScrolling),
        _classNames)
      ),
