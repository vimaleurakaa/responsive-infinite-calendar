      ...
      monthRows[i] = React.createElement(
        "ul",
        {
          ...
          className: classNames(
            styles.row,
            ((_classNames = {}),
            (_classNames[styles.partial] = row.length !== 7),
            _classNames)
          ),
  ...
  Month.prototype.render = function render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        "div",
        {
          className: `${styles.rows} calendar__month`,
          "data-month": this.props.monthDate,
        },
        this.renderRows(),
        showOverlay &&
          React.createElement(
            "label",
            {
              className: classNames(
                styles.label,
                ((_classNames2 = {}),
                (_classNames2[styles.partialFirstRow] = rows[0].length !== 7),
                _classNames2)
              ),
