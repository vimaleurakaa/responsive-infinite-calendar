...
var Calendar = (function (_Component) {
  ...
  function Calendar(props) {
    ...
    _this.handleScroll = function (scrollTop, e) {
      ...
      var scrollSpeed = (_this.scrollSpeed = Math.abs(
        _this.getScrollSpeed(scrollTop)
      ));
    ...
    _this.updateTodayHelperPosition = function (scrollSpeed) {
      ...
      // Today is below the fold
        ...
        scrollTop <=
        _this._todayOffset - height / 2 - rowHeight * (todayHelperRowOffset + 1)
      ) {
  ...
  Calendar.prototype.componentWillUpdate = function componentWillUpdate(
    nextProps,
    nextState
  ) {
      ...
      _extends(
        {
          ...
          className: classNames(
            ...
            ((_classNames = {}),
            (_classNames[styles.container.landscape] = layout === "landscape"),
            _classNames)
          ),
          ...
          _extends(
            {
              ...
              shouldAnimate: Boolean(
                shouldHeaderAnimate && display !== "years"
              ),
              layout: layout,
              theme: theme,
              locale: locale,
