  ...
  return React.createElement(
    "div",
    {
      className: classNames(
        styles.arrow,
        ((_classNames = {}),
        (_classNames[styles.arrowLeft] = direction === DIRECTIONS.LEFT),
        (_classNames[styles.arrowRight] = direction === DIRECTIONS.RIGHT),
        _classNames)
      ),
    ...
    React.createElement(
      ...
      React.createElement("path", {
        ...
        fill: "#FFF",
        transform:
          "translate(13.000000, 23.000000) rotate(90.000000) translate(-13.000000, -23.000000) ",
      })
    )
  );
};
