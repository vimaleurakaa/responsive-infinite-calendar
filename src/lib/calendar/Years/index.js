            ...
            return React.createElement(
              "li",
              {
                ...
                className: classNames(
                  ...
                  (_classNames[styles.currentMonth] = isCurrentMonth),
              ...
              return React.createElement(
                "div",
                {
                  ...
                  className: classNames(
                    styles.year,
                    ((_classNames2 = {}),
                    (_classNames2[styles.active] = !showMonths && isActive),
                    (_classNames2[styles.currentYear] =
                      !showMonths && year === currentYear),
                    (_classNames2[styles.withMonths] = showMonths),
                    (_classNames2[styles.first] = index === 0),
                    (_classNames2[styles.last] = index === years.length - 1),
                    _classNames2)
                  ),
